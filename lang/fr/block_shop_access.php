...
$string['shop:addinstance'] = 'Ajouter un bloc Boutique';
$string['shop:myaddinstance'] = 'Ajouter un bloc Boutique à Ma page';
$string['shop:paycheckoverride'] = 'Outrepasse le contrôle de paiement pour produire';
$string['shop:usenoninstantpayments'] = 'Peut utiliser les méthodes de paiement différées';
$string['shop:discountagreed'] = 'Est remisé pour tous ses achats avec le taux 1';
